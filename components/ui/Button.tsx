...
const variantStyles: Record<string, string> = {
  primary:   'bg-[var(--ink)] text-[var(--bg)] border-transparent shadow-[0_2px_12px_rgba(15,23,42,0.22)] hover:bg-[var(--ink-soft)] hover:shadow-[0_8px_24px_rgba(15,23,42,0.28)]',
